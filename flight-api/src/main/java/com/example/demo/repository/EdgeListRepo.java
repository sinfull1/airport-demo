...
public interface EdgeListRepo extends CrudRepository<EdgeList, String> {
    ...
    @Query(value = "select x.destination as destination, if (x.destination = :dest, true, false) as found, " +
    ...
    List<EdgeResultDao> getDestinations(@Param("origin") String origin, @Param("arrTime") Long arrTime, @Param("dest") String dest);
